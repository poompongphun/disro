                        ...
                        <div className="relative m-auto ">
                            <form className="bg-[#9CB8DD] w-[400px] p-10 rounded-md text-black">
                                ...
                                <div className="mt-6 flex justify-end">
                                    <button onClick={confirmHandler} className="bg-green-600 text-white p-2 rounded-md cursor-pointer">
                                        Confirm
                                    </button>
                                </div>
                            </form>
            ...
            <div className="flex h-screen flex-col w-full ">
                ...
                <div className="flex justify-center gap-64" >
                    <div className="flex flex-col px-8 py-16">
                        ...
                        <button onClick={()=>setShowPopup(true)} className="bg-white rounded-full text-black px-10 py-2 ">Change Password</button>
                    </div>
